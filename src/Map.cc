...
namespace ORB_SLAM3
{
  ...
  std::vector<PPEPointInterface *> Map::getPointsInCameraView(PPECameraInterface *camera, const Eigen::Matrix4f &viewMatrix) const
  {
    return std::vector<PPEPointInterface *>();
  }
