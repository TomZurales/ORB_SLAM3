...
namespace ORB_SLAM3
{
  ...
  void Viewer::Run()
  {
    ...
    pangolin::Var<bool> menuShowThesisVis("menu.Show Thesis Visualizations", false, true);

    if (menuShowThesisVis)
      pangolin::Var<bool> setRandomMapPointTarget("menu.Switch Map Point Target", false, false);
