...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, const bool& use_vbee = false, const bool& vbee_ransac = false, const int initFr = 0, const string &strSequence = std::string());
